...
class SudokuSolver {
    ...
    public static void main(String[] args) {
        sudokuBoard = new int[][] { { 3, 7, 8, 9, 2, 6, 4, 1, 5 }, { 4, 2, 9, 1, 5, 0, 0, 6, 0 },
                { 5, 6, 1, 3, 4, 0, 9, 2, 0 }, { 1, 9, 6, 7, 0, 5, 2, 8, 4 }, { 7, 4, 5, 2, 8, 1, 0, 9, 0 },
                { 0, 0, 2, 4, 6, 9, 0, 5, 7 }, { 9, 8, 4, 5, 1, 3, 6, 7, 2 }, { 2, 5, 7, 6, 9, 4, 0, 3, 1 },
                { 6, 1, 3, 8, 7, 2, 5, 4, 0 } };
    ...
    public static void Solve(int i, int j) {
        if (i < 9 && j < 9) {
            ...
            printResult();
            //System.exit(0); -- Un-comment this if you want to find one solution only.
        }
    }
